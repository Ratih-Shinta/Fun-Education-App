...
class ShowCurrentTugasModel {
    ...
    factory ShowCurrentTugasModel.fromJson(Map<String, dynamic> json) => ShowCurrentTugasModel(
        id: json["id"],
        shift: json["shift"],
        ...
        images: List<ShowCurrentTugasImageModel>.from(json["images"].map((x) => ShowCurrentTugasImageModel.fromJson(x))),
    );
