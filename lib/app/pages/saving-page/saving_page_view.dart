        ...
        child: LoadingOverlay(
                        ...
                        children: [
                          ...
                          AutoSizeText.rich(
                            ...
                            TextSpan(
                              ...
                              style:
                                  tsHeadingLargeSemibold(whiteColor).copyWith(
                                height: 1.3,
                              ),
                              children: [
                                TextSpan(
                                  ...
                                  children: [
                                    ...
                                    AutoSizeText.rich(
                                      TextSpan(
                                          ...
                                          style:
                                              tsBodyLargeSemibold(blackColor)),
                                    ),
                                  ],
                                ),
                              ),
                                  ...
                                  children: [
                                    ...
                                    AutoSizeText.rich(
                                      TextSpan(
                                          ...
                                          style:
                                              tsBodyLargeSemibold(whiteColor)),
                                      maxLines: 2,
                                    ),
                                  ],
                                ),
          ...
          itemBuilder: (BuildContext context, int index) {
            return TransactionHistory(
              categoryController:
                  transaksiPageController.showCurrentTransaksiModel[index].category!,
              amountController:
                  transaksiPageController.showCurrentTransaksiModel[index].amount!,
              descController:
                  transaksiPageController.showCurrentTransaksiModel[index].desc ??
                      'Tidak Ada',
